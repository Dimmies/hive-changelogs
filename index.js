let Logs = { // NEWEST LOG SHOULD BE ON TOP || MAKE SURE TO EDIT THE CURRENT VAR
	...
	"Thursday, July 15th 2021": {
		...
		"logs": {
			...
			7: { type: "bug", desc: "Disabled meth debug mode" },
			...
			13: { type: "bug", desc: "Decreased the Z coord for the Pacific Standard Bank zone" },
			...
			17: { type: "bug", desc: "Interact Slide-In now hides when you start playing Blackjack" },
			18: { type: "bug", desc: "Removed the Casino Teleported marker" },
			...
			21: { type: "bug", desc: "All unstored vehicles now store when the server starts (excluding impounded/repo'd vehicles)" },
			22: { type: "bug", desc: "Added commands (/givehousekey and /housekeys) to give house keys to the nearest person and view who has keys to your house." },
			23: { type: "bug", desc: "Removed ability to search fingerprints" },
			24: { type: "bug", desc: "Fixed stashes not working if 2 people try to open the same stash" },
			25: { type: "bug", desc: "Added ability for police to check the status of a nearby person" },
			26: { type: "bug", desc: "Increased Ammo item count in Ammunation" },
			27: { type: "bug", desc: "Fixed Black Shirt being shown when in the tattoo shop instead of no shirt" },
			28: { type: "bug", desc: "Added ability for anyone to change the Car Dealer displays when no dealers are online" },
			...
			33: { type: "bug", desc: "Added Undercover vehicles to sheriff garages" },
			...
			38: { type: "bug", desc: "Added a few more details to bug reports" },
